...
//        return nameTable.getIdentifier(codeLine.get(0).word).getCategory().equals(IdentifierCategory.VAR);
//    }
//
...
//
//        if (!nameTable.getIdentifier(ifThenCodeLine.get(1).word).getCategory().equals(IdentifierCategory.VAR)) {
...
//                break;
//            case NAME:
//                if (!nameTable.getIdentifier(ifThenCodeLine.get(3).word).getCategory().equals(IdentifierCategory.VAR)) {
//                    throw new ConditionAnalyzeException("Ожидается переменная");
//                }
//                break;
//            default:
